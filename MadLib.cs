...
namespace MadLib
{
    public class MadLib
    {
        //Master loop that cycles until user inputs q to quit
        public MadLib()
        {
                string Selection;
                ...
                void ShowMadLib(string madLib)
                {
                    Console.WriteLine(madLib);
                }

                //Method for gathering user input, comparing 
                void GatherWords(List<string> partsOfSpeech, string[] Words)
                {
                ...
                void ShowRealLyrics(string realLyrics)
                {
